...
if __name__ == '__main__':
    ...
    class Dataset(BaseDataset):
        ...
        def __init__(
            ...
            self.img_names = nn_lib.read_file_list(imgs_fn)
            self.mask_names = nn_lib.read_file_list(masks_fn)
        ...
        def __getitem__(self, i):
            ...
            image = nn_lib.remove_channel(image, channel)
    ...
    augmented_dataset = Dataset(
        ...
        train,
        train,
        augmentation=nn_lib.get_training_augmentation(CROPSIZE),
    )
    ...
    valid_dataset = Dataset(
        ...
        validate,
        validate,
        augmentation=nn_lib.get_validation_augmentation(CROPSIZE),
    )

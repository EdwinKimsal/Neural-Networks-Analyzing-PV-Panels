...
if __name__ == '__main__':
    ...
    model = nn_lib.SolarModel("FPN", "resnext50_32x4d", in_channels=4, out_classes=OUT_CLASSES, t_max=T_MAX)
    # # Model for Training 2
    # model = nn_lib.SolarModel("FPN", "mit_b0", in_channels=4, out_classes=OUT_CLASSES, t_max=T_MAX)
    # # Model for Trained Checkpoint 1
    # model = SolarModel.load_from_checkpoint(check_point_file, arch="FPN", encoder_name="resnext50_32x4d", in_channels=4,
    #                                         out_classes=OUT_CLASSES, t_max=T_MAX)
    # # Model for Trained Checkpoint 2
    # model = SolarModel.load_from_checkpoint(check_point_file, arch="FPN", encoder_name="mit_b0", in_channels=4,
    #                                         out_classes=OUT_CLASSES, t_max=T_MAX)

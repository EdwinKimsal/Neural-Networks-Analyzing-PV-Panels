...
# Customizable vars
input_file = "All Test Files"
output_file_png = "Input Test Images"
output_file_json = "Input Test JSON"
output_file_jp2 = "Input Test JP2"
...
for file in file_list:
    ...
    # If file is a JSON...
        ...
        with open(os.path.join(input_file_path, file), "w+") as f:
            json.dump(os.path.join(input_file_path, file), os.path.join(output_file_path_json, file))
